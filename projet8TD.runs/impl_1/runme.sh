...
HD_PWD='C:/Users/Baptiste/Documents/ENSEA/3D/S10_007_Soc/002_TD/vivado_projet_zynq/projet8TD.old1/projet8TD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_1_wrapper.tcl -notrace
