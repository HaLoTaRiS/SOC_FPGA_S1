...
proc create_root_design { parentCell } {
  ...
  # Create instance: accu_0, and set properties
  set block_name accu
  set block_cell_name accu_0
  if { [catch {set accu_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net accu_0_somme [get_bd_pins accu_0/somme] [get_bd_pins axi_gpio_1/gpio_io_i]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins accu_0/start] [get_bd_pins axi_gpio_0/gpio2_io_o]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins accu_0/clk] [get_bd_pins axi_gpio_0/gpio_io_o]
